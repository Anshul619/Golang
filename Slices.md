# What is "slice" in Go?
- [Slice](https://go.dev/blog/slices-intro) is a lightweight data structure of variable length sequence for storing homogeneous data.
...
- [Read more](https://trstringer.com/golang-append/)